...
<button style="width: 20%" class="btn_modal" id="btn_book_spex" type="button">Boka biljetter</button>
...
<p class="Ticketp" style="width: 80%"><?php include('opera_antal_biljetter.php') ?>
</p>
</div>
...
<p class="Ticketp" style="width: 90%"><?php include('cirkus_antal_biljetter.php') ?>
</p>
</div>
...
<p class="Ticketp" style="width: 90%"><?php include('barneval_antal_biljetter.php') ?>
</p>
</div>
...
<p class="Ticketp" style="width: 90%"><?php include('kabaren_antal_biljetter.php') ?>
</p>
</div>
...
<p class="Ticketp" style="width: 90% float: right"><?php include('showen_antal_biljetter.php') ?>
</p>
</div>
